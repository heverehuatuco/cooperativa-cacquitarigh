...
export default function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-primary-brand pt-24 pb-10 flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 flex flex-col items-center mt-4">
        ...
        <div className="mt-16 md:mt-24 relative w-full max-w-5xl h-[380px] sm:h-[420px] md:h-[450px] flex justify-center items-center perspective-1000">
