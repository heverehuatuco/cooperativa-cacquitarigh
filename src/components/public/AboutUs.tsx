    ...
    <section id="nosotros" className="relative pt-8 pb-20 bg-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 mb-20 relative mt-10">
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-extrabold text-stone-900 mb-6 tracking-tight leading-snug">
              Mejorando vidas a través de un café y cacao sostenible.
            </h3>
            
            <div className="space-y-4 text-stone-600 leading-relaxed text-[15px] sm:text-base">
              <p>
                Fundada el <strong>02 de febrero del 2024</strong> por un grupo de jóvenes productores en San Martin de Pangoa, Satipo Junín. 
                Liderada por nuestro Gerente General, <strong>Samuel Kevin Taype Manrique</strong>, la cooperativa nació con una visión clara:
              </p>
              ...
              <p>
                Hoy agrupamos a más de <strong>200 jóvenes productores</strong>. Hemos implementado tecnologías de la información y alianzas especializadas de comercio justo. 
              </p>
              <p>
                En su corta historia (2024) obtuvimos la <strong>certificación de café orgánico</strong> y en 2025 logramos exportar nuestro primer contenedor a <strong>Europa</strong>.
              </p>
            </div>
