          ...
          <div className="w-full flex justify-between flex-col lg:w-2/5">
            ...
            <div className="flex items-center lg:justify-start justify-center lg:mt-0 mt-8 gap-8 mb-4">
              <button 
                ...
                className="group flex justify-center items-center border border-solid border-secondary-brand w-11 h-11 transition-all duration-500 rounded-full hover:bg-secondary-brand"
              >
                <svg className="h-6 w-6 text-secondary-brand group-hover:text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
